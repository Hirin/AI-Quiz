const JSON_FILES = [
    "data/A1_BasicLinear.json",
    "data/A2_Eigenvalue.json",
    "data/A3_BasicProbability.json",
    "data/A4_Distributions.json",
    "data/A5_Statistics.json",
    "data/A6_Calculus.json",
    "data/A_Remaining.json",
    "data/A9_Distance_Extra.json",
    "data/A10_Numerical_Extra.json",
    "data/B1_PythonBasics.json",
    "data/B2_PythonAdvanced.json",
    "data/B3_DataStructures.json",
    "data/B4_NumpyPandas.json",
    "data/B5_SQL.json",
    "data/B6_Pipelines.json",
    "data/B_Remaining.json",
    "data/B9_Testing.json",
    "data/B10_Visualization.json",
    "data/B11_Regex.json",
    "data/B12_CPP_Basics.json",
    "data/B13_CPP_Advanced.json",
    "data/C1_Supervised.json",
    "data/C1_Supervised_Extra.json",
    "data/C2_ModelEval.json",
    "data/C3_DeepLearning.json",
    "data/C3_DeepLearning_Extra.json",
    "data/C4_C5_NLP_CV.json",
    "data/C_Remaining.json",
    "data/C_Extra.json",
    "data/C9_LLM_Extra.json",
    "data/C10_RL.json",
    "data/C11_TimeSeries_RecSys.json",
    "data/C12_FeatureEng.json",
    "data/D1_D2_LogicEthics.json",
    "data/D_Remaining.json",
    "data/D_Extra.json",
    "data/D8_Regulation_Extra.json",
    "data/D9_IP_Society.json",
    "data/D10_Communication.json"
];
